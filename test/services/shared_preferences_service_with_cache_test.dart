...
void main() {
  ...
  late SharedPreferencesServiceWithCache service;
  ...
  setUp(() async {
    ...
    service = SharedPreferencesServiceWithCache(prefs);
  });
  ...
  group('SharedPreferencesServiceWithCache', () {
    ...
    test('should handle supported value types appropriately', () async {
      expect(
