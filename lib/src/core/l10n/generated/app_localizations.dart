...
abstract class AccessibilityLocalizations {
  ...
  /// Returns the instance of this localizations class that is associated with
  /// the given context.
  ...
  switch (locale.languageCode) {
    ...
    case 'fil':
      return app_localizations_fil.loadLibrary().then(
            (dynamic _) =>
                app_localizations_fil.AccessibilityLocalizationsFil(),
          );
    case 'fr':
    ...
    case 'gsw':
      return app_localizations_gsw.loadLibrary().then(
            (dynamic _) =>
                app_localizations_gsw.AccessibilityLocalizationsGsw(),
          );
    case 'gu':
