import 'package:accessibility/src/core/l10n/generated/app_localizations_no.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  group('AccessibilityLocalizationsNo', () {
    late AccessibilityLocalizationsNo loc;

    setUp(() {
      loc = AccessibilityLocalizationsNo();
    });

    test('should have the correct locale name', () {
      expect(loc.localeName, equals('no'));
    });
    ...
    test('should return the correct basic string values', () {
      ...
      expect(loc.align_center, equals('Sentrer'));
      expect(loc.align_left, equals('Venstrejuster'));
      expect(loc.align_right, equals('Høyrejuster'));
    ...
    test('should return the correct change-related string values', () {
      ...
      expect(
        ...
        equals('Endre bakgrunnsfargen på sidene til: '),
      );
      expect(
        loc.change_text_color,
        equals('Endre fargen på teksten til: '),
      );
      expect(
        loc.change_text_color_shade,
        equals('Endre nyansen av fargen til: '),
      );
    ...
    test('should return the correct increment/decrement string values', () {
      ...
      expect(
        ...
        equals('Reduser tekstskaleringsfaktor'),
      );
      ...
      expect(
        ...
        equals('Øk tekstskaleringsfaktor'),
      );
    });
    ...
    test('should return the correct theme string values', () {
      ...
      expect(loc.theme_profile('seizureSafe'), equals('Epilepsisikker'));
      expect(loc.theme_profile('visionImpaired'), equals('Synshemmet'));
      expect(loc.theme_profile('adhdFriendly'), equals('ADHD-vennlig'));
      expect(loc.theme_profile('none'), equals('Standardprofil'));
      expect(
        loc.theme_profile_seizure_safe_title,
        equals('Epilepsisikker profil'),
      );
      expect(
        loc.theme_profile_seizure_safe_subtitle,
        equals('Fjern refleksjoner og reduser farge'),
      );
      expect(
        loc.theme_profile_seizure_safe_description,
        equals(
          'Denne profilen gjør det mulig for brukere som har '
          'epilepsi og er i fare for anfall å surfe trygt ved å '
          'eliminere risikoen for anfall som skyldes blinkende '
          'animasjoner og risikable fargekombinasjoner.',
        ),
      );
      expect(
      ...
      expect(
        ...
        equals(
          'Denne profilen tilpasser applikasjonen til å være '
          'tilgjengelig for de fleste synshemninger, som '
          'synshemming, tunnelsyn, grå stær, grønn stær og mer.',
        ),
      );
      expect(
      ...
      expect(
        ...
        equals(
          ...
          'på de essensielle elementene i applikasjonen enklere.',
        ),
      );
      expect(
      ...
      expect(loc.toggle_dark_mode, equals('Slå på/av mørk modus'));
      expect(loc.toggle_effects_mode, equals('Slå på/av effektmodus'));
      expect(loc.toggle_font_weight, equals('Slå på/av skriftvekt'));
      expect(loc.toggle_theme_profile, equals('Slå på/av temaprofil'));
    });
    ...
    test('should return the correct color select values', () {
      ...
      expect(loc.color('c009688'), equals('Turkis'));
