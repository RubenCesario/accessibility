...
class AccessibilityLocalizationsTe extends AccessibilityLocalizations {
  ...
  @override
  String get accessible_font => 'అందుబాటులో ఉన్న ఫాంట్';
  ...
  String get accessible_font_enabled =>
      'అందుబాటులో ఉన్న ఫాంట్ ప్రారంభించబడింది';

  @override
  String get accessible_font_disabled =>
      'అందుబాటులో ఉన్న ఫాంట్ నిలిపివేయబడింది';

  @override
  String get toggle_accessible_font => 'అందుబాటులో ఉన్న ఫాంట్‌ని టాగుల్ చేయండి';
}
