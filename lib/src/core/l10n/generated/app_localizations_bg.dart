...
class AccessibilityLocalizationsBg extends AccessibilityLocalizations {
  ...
  @override
  String get text_alignment => 'Подравняване на текста';
  ...
  @override
  String get accessible_font => 'Достъпен шрифт';
  ...
  @override
  String get accessible_font_disabled => 'Достъпен шрифт изключен';

  @override
  String get toggle_accessible_font => 'Превключи достъпен шрифт';
}
