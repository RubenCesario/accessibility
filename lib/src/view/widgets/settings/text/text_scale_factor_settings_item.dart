...
/// scale factor of all text of the application.
final class TextScaleFactorSettingsItem extends SettingsItem {
  /// Creates an [TextScaleFactorSettingsItem] Widget.
  const TextScaleFactorSettingsItem({super.key});

  @override
  State<TextScaleFactorSettingsItem> createState() =>
      _TextScaleFactorSettingsItemState();
}

class _TextScaleFactorSettingsItemState
    extends State<TextScaleFactorSettingsItem> {
  final double _minSliderValue = kMinScaleFactorSliderValue;
  final double _maxSliderValue = kMaxScaleFactorSliderValue;
  ...
  Future<void> _storeTextScaleFactor(double newSetting) async =>
      _prefsInherited.storeTextScaleFactorSetting(
        ...
        children: [
          IconButton(
            onPressed: () async {
              ...
              _settingsInherited.updateScaleFactorSetting(_sliderValue);
              await _storeTextScaleFactor(_sliderValue);
            },
            icon: Icon(
              size: IconSize.large,
              semanticLabel: context.l10na.decrement_text_scale_factor,
              Icons.remove,
            ),
          ),
          Flexible(
                  ...
                  child: SliderTheme(
                    ...
                    child: Slider.adaptive(
                      ...
                      onChanged: (value) {
                        _sliderValue = value;
                        _settingsInherited
                            .updateScaleFactorSetting(_sliderValue);
                      },
                      onChangeEnd: _storeTextScaleFactor,
                      min: _minSliderValue,
                      max: _maxSliderValue,
          ...
          IconButton(
            ...
            icon: Icon(
              size: IconSize.large,
              semanticLabel: context.l10na.increment_text_scale_factor,
              Icons.add,
            ),
          ),
        ],
