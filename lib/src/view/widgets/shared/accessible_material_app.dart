...
/// {@template AccessibleMaterialApp}
...
/// {@endtemplate}
final class AccessibleMaterialApp extends StatefulWidget {
  /// {@macro AccessibleMaterialApp}
  const AccessibleMaterialApp({
    super.key,
    this.navigatorKey,
  ...
  /// Creates a [AccessibleMaterialApp] that uses the [Router]
  /// instead of a [Navigator].
  ///
  /// {@macro flutter.widgets.WidgetsApp.router}
  const AccessibleMaterialApp.router({
    super.key,
    this.scaffoldMessengerKey,
    ...
    this.themeAnimationStyle,
          ...
          'Either routerDelegate or routerConfig must be non-null',
        ),
  ...
  /// and widgets such as [Tooltip], [PopupMenuButton], also
  /// require a [Navigator] to properly function.
  ...
  @override
  State<AccessibleMaterialApp> createState() => _AccessibleMaterialAppState();
}
        ...
        builder: (
          ...
          return widget.routerDelegate != null || widget.routerConfig != null
              ? MaterialApp.router(
                  ...
                  color: widget.color,
                  themeMode: themeMode,
                  theme: accessibleThemeData,
                  darkTheme: accessibleDarkThemeData,
                  highContrastTheme: accessibleHighContrastThemeData,
                  highContrastDarkTheme: accessibleHighContrastDarkThemeData,
                  localizationsDelegates: widget.localizationsDelegates != null
                      ? [
